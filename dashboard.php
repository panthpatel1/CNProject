	...
	<div class="col-md-12">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<p href="product.php" style="text-decoration:none;color:black;">
				<i class="glyphicon glyphicon-warning-sign"></i> [Deprecated Product] This product was designed by <a target="_blank" href="https://www.immortal.org.in">Immortal Corporation</a> to provide a basic starter kit on local environments and shall not be deployed on production servers. Please get an upgraded, production ready code from our website or contact support.	
				</p>
			</div> <!--/panel-hdeaing-->
		</div> <!--/panel-->
	</div>
